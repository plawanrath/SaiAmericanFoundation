//
//  SaiDivineOlder1ViewController.swift
...
class SaiDivineOlder1ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let pdfPath = Bundle.main.url(forResource: "MagazineOlder1", withExtension: "pdf"),
